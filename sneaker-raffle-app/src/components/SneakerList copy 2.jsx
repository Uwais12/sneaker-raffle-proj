    ...
    <div>
      <div className="grid grid-cols-1 sm:grid-cols-4 lg:grid-cols-4 gap-8">
        ...
        {sneakers.map((sneaker) => (
          ...
          <div className="relative bg-gray-900 text-white overflow-hidden rounded-xl shadow-2xl flex flex-col hover:flex-row hover:col-span-2 hover:transition-all">
            <div className="w-full hover:w-1/2 h-1/3 hover:h-full">
            ...
            <div className="flex-grow p-6 md:p-10 w-full hover:w-1/2">
              <h2 className="text-4xl font-bold mb-4">{sneaker.name || 'YEXZY'}</h2>
            ...
            <div className="absolute bottom-0 right-0 bg-blue-500 text-black px-3 py-1 text-lg font-bold rounded-tl-md">
              ID:
              {' '}
              {sneaker.id}
            </div>
